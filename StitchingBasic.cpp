...
CImageStitchBasic::CImageStitchBasic()
{
	...
	imgMarkR.imgRed = cmatrix(imgR.nH, imgR.nW);
	imgMarkR.imgGreen = cmatrix(imgR.nH, imgR.nW);
	imgMarkR.imgBlue = cmatrix(imgR.nH, imgR.nW);
	...
	GetCurrentImageColor(imgMarkR.imgRed, imgMarkR.imgGreen, imgMarkR.imgBlue, 0);
...
CImageStitchBasic::~CImageStitchBasic()
{
	...
	free_cmatrix(imgMarkR.imgRed, imgR.nH, imgR.nW);
	free_cmatrix(imgMarkR.imgGreen, imgR.nH, imgR.nW);
	free_cmatrix(imgMarkR.imgBlue, imgR.nH, imgR.nW);
...
void CImageStitchBasic::DrawFeature()
{
	...
	for (int i = 0; i < nNumPoint; i++)
	{
		DrawCross(imgMarkR.imgRed, imgR.nW, imgR.nH, CPoint(GodPointL[i].x, GodPointL[i].y), arrColor[0]);
		DrawCross(imgMarkR.imgGreen, imgR.nW, imgR.nH, CPoint(GodPointL[i].x, GodPointL[i].y), arrColor[1]);
		DrawCross(imgMarkR.imgBlue, imgR.nW, imgR.nH, CPoint(GodPointL[i].x, GodPointL[i].y), arrColor[2]);
	}

	DisplayCimage2DColor(imgMark.imgRed, imgMark.imgGreen, imgMark.imgBlue, imgR.nW, imgR.nH, imgR.nPosX, imgR.nPosY);
	DisplayCimage2DColor(imgMarkR.imgRed, imgMarkR.imgGreen, imgMarkR.imgBlue, imgR.nW, imgR.nH, imgR.nPosX, imgR.nPosY);
}
...
void CImageStitchBasic::MultiBandBlending(int nH, int nW, BYTE** Result_R, BYTE** Result_G, BYTE** Result_B)
{
	...
	double dSigma = 30; // Gaussian's sigma
